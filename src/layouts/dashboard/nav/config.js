...
const navConfig = [
  ...
  //     {
  //       title: 'Thành Công',
  //       path: '/dashboard/session-success',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Chưa Thanh Toán',
  //       path: '/dashboard/session-not-pay',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Thất bại',
  //       path: '/dashboard/session-out-of-date',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Đang diễn ra',
  //       path: '/dashboard/session-instage',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Chưa bắt đầu',
  //       path: '/dashboard/session-not-start',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Đã nhận hàng',
  //       path: '/dashboard/session-received',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Sản phẩm lỗi',
  //       path: '/dashboard/session-error-item',
  //       icon: <Icon icon='mingcute:auction-fill' width='30' height='30' />,
  //     },
  //   ],
  // },
  ...
  //     {
  //       title: 'Chưa có phiên',
  //       path: '/dashboard/booking-item-no-session',
  //       icon: <Icon icon='mdi:form' width='30' height='30' />,
  //     },
  //     {
  //       title: 'Đơn ưu tiên',
  //       path: '/dashboard/booking-item-now',
  //       icon: <Icon icon='mdi:form' width='30' height='30' />,
  //     },
  //   ],
  // },

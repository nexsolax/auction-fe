...
const OpenAuctionForm = () => {
  ...
  const handleSubmit2 = (event) => {
    ...
    ({
      method: "put",
      url: `https://reasapiv2.azurewebsites.net/api/Auction/${auctionId}/close`,
      data: formData,
          ...
          >
            ...
            <Button
              ...
              >
                {" "}
                {`${
                  row.status === "Approved" ? "Xác nhận mở đấu giá" : "Đấu giá đã mở"
                }`}{" "}
              </Button>
              <Button
                variant="contained"
              ...
              >
                {" "}
                {`${
                  row.status === "OnGoing" ? "Đóng đấu giá" : "Đấu giá đã kết thúc"
                }`}{" "}
              </Button>
            </TableCell>
          </TableRow>

...
// sections
import { getSessionsInStage, getStatusInfo } from '../services/session-actions';
...
export default function SessionInStage() {
  ...
  useEffect(() => {
    getSessionsInStage().then((response) => {
                      ...
                      <TableRow hover key={sessionId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="right">
                          ...
                          >
                            ...
                            <MenuItem>
                              <Link to={`/dashboard/session-history/${row.sessionId}`}>
                                <Button>
